...
<div>
    ...
    <div>
        <input type="checkbox" id="enable-financial-columns" /> Enable financial columns
    </div>
    <table>
        <tr>
            ...
            <th class="column-10">Billable hours<br />
                <p style="font-size: 13px;">Name  &nbsp;&nbsp;&nbsp; Hours X Rate = Subtotal</p>
            </th>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td align="right" class="financial"><?php echo number_format((float)$estimatedCost, $decimals = 2); ?></td>
                    <td><?php if ($task['date_completed'] != null) {
                            echo date('d-m-Y', $task['date_completed']);
                        } ?></td>
                    <td>                        <?php if (count($task['billable_hours']) > 0) { ?>
                            <table>                                <?php foreach ($task['billable_hours'] as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: none;padding: 0px;"><?php echo number_format((float)$user['hours'], 1, '.', ''); ?> X <?php echo $task['price']; ?></td>
                                    </tr>                                <?php } ?>
                            </table>                        <?php } ?>                    </td>
            ...
            <tr>
                ...
                <td></td>
                <td>Total Billable: <?php echo number_format($totalBillable, $decimals = 2); ?></td>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo date('d-m-Y', $task['date_creation']); ?></td>
                        <td><?php echo $task['time_estimated']; ?></td>
                        <td class="financial" align="right"><?php echo number_format((float)$estimatedCost, $decimals = 2); ?></td>
                        <td><?php if ($task['date_completed'] != null) {
                                echo date('d-m-Y', $task['date_completed']);
                            } ?></td>
                        <td>                            <?php if (count($task['billable_hours']) > 0) { ?>
                                <table>                                    <?php foreach ($task['billable_hours'] as $user) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: none;padding: 0;"><?php echo number_format((float)$user['hours'], 1, '.', ''); ?></td>
                                        </tr>                                    <?php } ?>
                                </table>                            <?php } ?>                        </td>
                    </tr>                    <?php $totalBillable += $taskBillableHours;
                    $totalEstimate += $estimatedCost; ?><?php } ?>
