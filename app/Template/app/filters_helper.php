...
<div class="dropdown">
    <a href="#" class="dropdown-menu dropdown-menu-link-icon filter-main-search" title="<?= t('Default filters') ?>"><i class="fa fa-filter fa-fw filter-black"></i><i class="fa fa-caret-down filter-black"></i></a>
    <ul>
